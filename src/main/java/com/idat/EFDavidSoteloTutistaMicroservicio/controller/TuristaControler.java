package com.idat.EFDavidSoteloTutistaMicroservicio.controller;
...
import com.idat.EFDavidSoteloTutistaMicroservicio.service.TuristaService;

@Controller
@RequestMapping("/api/turista/evfinal")
public class TuristaControler {
